  ...
  const allComments = [
    {
      ...
      date: "2024.01.15",
      content:
        "정말 최고의 게임입니다! 오픈월드의 자유도가 엄청나고, 어디로 가야 할지 모르는 재미가 있어요. 처음에는 어려웠지만 점점 익숙해지면서 더욱 재밌어졌습니다. 강력 추천!",
      likes: 24,
    },
    {
      id: 2,
      ...
      date: "2024.01.12",
      content:
        "그래픽이 정말 아름답고 음악도 환상적이에요. 다만 무기가 부서지는 시스템은 좀 아쉬웠습니다. 그래도 전체적으로 훌륭한 게임이고 시간 가는 줄 모르고 플레이했어요!",
      likes: 18,
    },
    {
      id: 3,
      ...
      date: "2024.01.10",
      content:
        "100시간 넘게 플레이했는데도 아직 할 게 많아요. 탐험의 재미가 끝이 없고, 퍼즐을 풀 때마다 성취감이 정말 크네요. 닌텐도 스위치 필수 게임!",
      likes: 31,
    },
    {
      id: 4,
      ...
      date: "2024.01.08",
      content:
        "기대했던 것보다는 아쉬웠어요. 스토리가 좀 단조로운 느낌이고, 던전이 예전 젤다 시리즈보다 부족한 것 같아요. 그래도 오픈월드는 재밌습니다.",
      likes: 7,
    },
    {
      id: 5,
      ...
      date: "2024.01.05",
      content:
        "이런 게임이 있을 줄 몰랐어요! 자유도가 정말 높고, 어떤 방식으로 플레이해도 재밌네요. 요리 시스템도 재밌고, 물리 엔진도 정말 잘 만들어져 있어요.",
      likes: 15,
    },
    {
      id: 6,
      ...
      date: "2024.01.03",
      content:
        "닌텐도가 이런 게임을 만들 수 있다니! 평소 젤다 시리즈를 좋아했는데 이번 작품은 정말 혁신적이네요. 다만 프레임 드롭이 가끔 있어서 아쉬워요.",
      likes: 22,
    },
    {
      id: 7,
      ...
      date: "2024.01.02",
      content:
        "처음에는 복잡해 보였는데 플레이하면 할수록 매력적이에요. 특히 날씨 시스템이 정말 잘 만들어져 있고, 비 올 때 바위 타기가 어려워지는 디테일이 좋네요!",
      likes: 28,
    },
    {
      id: 8,
      ...
      date: "2023.12.30",
      content:
        "요리 시스템이 너무 재밌어요! 다양한 재료를 조합해서 새로운 요리를 만드는 재미가 쏠쏠합니다. 가끔 이상한 조합으로 요리해서 웃기기도 하고ㅋㅋ",
      likes: 19,
    },
    {
      id: 9,
      ...
      date: "2023.12.28",
      content:
        "슈링크 120개 다 찾았어요! 퍼즐 난이도가 정말 다양하고 창의적이네요. 어떤 건 정말 머리를 쥐어짜야 해서 더 재밌었습니다. 완전 추천!",
      likes: 35,
    },
    {
      id: 10,
      ...
      date: "2023.12.25",
      content:
        "풍경이 정말 아름다워요. 사진 모드로 스크린샷 찍는 재미가 있고, 일출과 일몰 시간대 풍경은 정말 예술입니다. 다만 스토리가 좀 아쉬웠어요.",
      likes: 12,
    },
    {
      id: 11,
      ...
      date: "2023.12.22",
      content:
        "무기가 부서지는 시스템 때문에 좋은 무기를 아껴쓰게 되더라고요. 이 부분은 호불호가 갈릴 것 같아요. 그래도 다양한 무기를 시도해보게 되는 장점은 있네요.",
      likes: 8,
    },
    {
      id: 12,
      ...
      date: "2023.12.20",
      content:
        "코로그 씨앗 900개 다 모으는데 200시간 걸렸어요ㅠㅠ 하지만 그만큼 재밌었습니다! 숨겨진 코로그들을 찾는 재미가 정말 중독적이에요.",
      likes: 42,
    },
    {
      id: 13,
      ...
      date: "2023.12.18",
      content:
        "보스 전투가 정말 짜릿해요! 특히 가논과의 최종 결전은 손에 땀을 쥐게 하더라고요. 다양한 공략법이 있어서 여러 번 플레이해도 재밌어요.",
      likes: 26,
    },
    {
      id: 14,
      ...
      date: "2023.12.15",
      content:
        "물리 엔진을 이용한 퍼즐들이 정말 창의적이에요. 개발자가 의도하지 않은 해법도 많아서 자유도가 높네요. 이런 게임은 처음 봐요!",
      likes: 33,
    },
    {
      id: 15,
      ...
      date: "2023.12.12",
      content:
        "스위치로 이런 거대한 오픈월드를 돌리다니 정말 대단해요. 가끔 프레임 드롭이 있긴 하지만 휴대용으로 이 정도면 만족합니다. 통근길에 최고!",
      likes: 17,
    },
  ];
        ...
        {comments.map((comment) => (
          <div key={comment.id} className="bg-slate-700 rounded-lg p-4">
            <div className="flex items-start space-x-3">
              <div
                className={`w-10 h-10 bg-gradient-to-br ${comment.avatarColor} rounded-full flex items-center justify-center text-white font-bold`}
              >
                {comment.avatar}
              </div>
