...
export default function IOSRankingPage() {
  ...
  useEffect(() => {
    const fetchIOSRankings = async () => {
      try {
        ...
        const mapped: IOSGame[] = ((data as RankGameRow[] | null) || []).map(
          (row, index) => {
            ...
            return {
              ...
              img: row.image_url || "/icon/rank_icon/mobile1.jpeg",
              rank: row.rank,
        ...
        setError("iOS 게임 랭킹 데이터를 불러오는 중 오류가 발생했습니다.");
        console.error("iOS 게임 랭킹 가져오기 실패:", err);
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-slate-900/95 border border-slate-700/50 rounded-2xl p-6 space-y-4 mb-8 shadow-lg shadow-black/20">
          ...
          <div className="flex items-center gap-4 text-xs text-slate-500">
            ...
            <span>데이터 제공: <a href="https://apps.apple.com" className="text-orange-500 hover:text-orange-400 transition-colors">apps.apple.com</a></span>
