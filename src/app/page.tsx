...
export default function Home() {
    ...
    const prevSmallSlide = () => {
        setCurrentSmallSlide(
            (prev) =>
                (prev - 1 + (smallSlides.length - 3)) % (smallSlides.length - 3)
        );
    };
    ...
    return (
        <div className="min-h-screen bg-slate-900">
            ...
            {/* 히어로 섹션 */}
            <section className="relative h-30 bg-gradient-to-r from-indigo-600 to-orange-700 flex items-center justify-center">
