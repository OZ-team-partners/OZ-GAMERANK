        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 flex items-center justify-center relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute top-32 left-1/4 animate-float">
                    <Trophy className="text-indigo-400/30" size={24} />
                </div>
                <div className="absolute bottom-40 right-1/4 animate-float-delayed">
                    <Gamepad2 className="text-purple-400/30" size={28} />
                </div>
                <div className="absolute top-1/3 right-1/5 animate-float-slow">
                    <Star className="text-emerald-400/30" size={20} />
                </div>
            </div>
                                ...
                                <div className="mt-8 space-y-4">
                                    <div className="flex justify-between items-center">
                                        <Button
                                            variant="text"
                                            size="small"
                                            className="text-indigo-400 hover:text-indigo-300 p-0 min-w-0"
                                            sx={{
                                                textTransform: "none",
                                                fontSize: "14px",
                                                color: "#a5b4fc",
                                        ...
                                        <Button
                                            variant="text"
                                            size="small"
                                            className="text-slate-300 hover:text-white p-0 min-w-0"
                                            sx={{
                                                textTransform: "none",
                                                fontSize: "14px",
                                                color: "#cbd5e1",
